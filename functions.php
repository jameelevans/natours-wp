...
add_action( 'after_setup_theme', 'natours_custom_logo_setup' );
...
function theme_enqueue_scripts() {
  ...
  wp_enqueue_style('natours_main_styles', get_stylesheet_uri());
...
function natours_custom_logo_setup() {
  $defaults = array(
      'height'      => 38,
      'width'       => 38,
      'flex-height' => true,
      'flex-width'  => true,
      'header-text' => array( 'Natour', 'Exciting tours for adventurous people' ),
  );
